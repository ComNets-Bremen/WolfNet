...
class BOARD:
    ...
    LED  = None   # RaspPi GPIO 13 connects to the LED and a resistor (1kohm or 330ohm)
...
class BOARD2:
    ...
    """
    # Note that the BCOM numbering for the GPIOs is used.
    DIO0 = 4   # RaspPi GPIO 23
    DIO1 = 23   # RaspPi GPIO 24                                                                                         
    DIO2 = 24   # RaspPi GPIO 25
    DIO3 = 27   # RaspPi GPIO 5
    RST  = 17   # RaspPi GPIO 6
    LED  = None   # RaspPi GPIO 19 connects to the LED and a resistor (1kohm or 330ohm)
    #SWITCH = 4  # RaspPi GPIO 4 connects to a switch - not necessary
